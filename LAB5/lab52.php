...
<?php
// Solo aceptar archivo menores p igual a 1MB y que sean de tipo imagen jpg,jpeg, gif o png
if ($_FILES["archivo_cliente"]["size"] < 1000000 && ($_FILES["archivo_cliente"]["type"] == "image/jpeg" || $_FILES["archivo_cliente"]["type"] == "image/gif" || $_FILES["archivo_cliente"]["type"] == "image/png" || $_FILES["archivo_cliente"]["type"] == "image/jpg")) {
